...
import { getPostById, updatePost, markTopicPublished } from '../../admin-data.js';
import { getSupabaseClient } from '../../supabase.js';
import { getImageAltByFilename } from '../../images.js';
import { indexContent } from '../../rag.js';
import { todayInLA } from '../../cron.js';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // '../../publish.js', not '../../lib/publish.js': this handler moved
    // from api/admin/ into lib/endpoints/admin/ in the function
    // consolidation, which shifted what '../..' resolves to.
    const { publishPost } = await import('../../publish.js');
    // Publish date in Gregg's timezone, not UTC (see scripts/sweep-and-publish.js).
